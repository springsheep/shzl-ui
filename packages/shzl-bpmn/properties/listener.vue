<template>
   <el-drawer :title="title" :visible.sync="_listenerDrawer" direction="rtl" @open="init" :modal-append-to-body="false">
...
export default {
   ...
   methods: {
      init() {
         (this.eventTypes = this.type === 'Execution' ? this.excutionEventTypes : this.taskEventTypes), (this.showForm = false);
         this.listener = {
            id: '',
            eventType: 'start',
            listenerType: 'class',
