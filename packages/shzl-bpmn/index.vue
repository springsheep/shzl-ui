<template>
   <el-container v-loading="isView" class="fm2-container" :class="{ 'view-mode': isView }">
      <el-header height="43px">
         <el-button icon="el-icon-back" @click="$emit('backList')">返回模型列表</el-button>
         <el-button-group style="margin: 5px">
            <el-button icon="el-icon-arrow-left" @click="handleUndo">撤回</el-button>
            <el-button icon="el-icon-refresh-right" @click="handleRedo">重做</el-button>
            ...
            <el-button icon="el-icon-download" @click="handleExportXmlAction('bpmn')">bpmn</el-button>
            <el-button icon="el-icon-download" @click="handleExportXmlAction('xml')">XML</el-button>
            <el-button icon="el-icon-download" @click="handleExportSvgAction">SVG </el-button>
            ...
            <el-button icon="el-icon-upload" @click="handleSave">保存 </el-button>
         </el-button-group>
      </el-header>
      <el-main class="fm2-main">
         <el-container class="center-container">
            ...
            <el-aside class="widget-config-container">
               <bpmn-element ref="_bpmnElement" v-if="modeler" :modeler="modeler" :processCategory="processCategory" :taskCategory="taskCategory" />
            </el-aside>
         </el-container>
      </el-main>
      ...
      <el-dialog :visible.sync="xmlVisible" title="预览" fullscreen center :modal-append-to-body="false" width="">
         <vue-ace-editor
            v-model="process.xml"
            @init="editorInit"
            lang="xml"
         ...
         <span slot="footer">
            <el-button icon="el-icon-document" type="primary" v-clipboard:copy="process.xml" v-clipboard:success="onCopy">复 制</el-button>
...
export default {
   ...
   methods: {
      ...
      // 导出XML文件
      handleExportXmlAction(type) {
         const _this = this;
         this.modeler.saveXML({ format: true }, function(err, xml) {
            xml = _this.replaceLtAndGt(xml);
            _this.download(type, xml, _this.getProcess().name + `.bpmn20.${type}`);
         });
      },
      // 导出SVG文件
      ...
      // 前进
      handleRedo() {
         console.log(this.modeler.get('commandStack'));
         this.modeler.get('commandStack').redo();
      },
      // 后退
      handleUndo() {
         console.log(this.modeler.get('commandStack').undo());
