<template>
   <span class="fm-style">
      <el-header height="45px" style="padding:0px">
         <el-button icon="el-icon-back" @click="$emit('back')">返回列表</el-button>
         <el-button-group style="margin: 5px">
            <el-button v-if="upload" icon="el-icon-upload2" @click="handleUpload">{{ $t('fm.actions.import') }}</el-button>
            <el-button v-if="clearable" icon="el-icon-delete" @click="handleClear">{{ $t('fm.actions.clear') }}</el-button>
            <el-button v-if="preview" icon="el-icon-view" @click="handlePreview">{{ $t('fm.actions.preview') }}</el-button>
            <el-button v-if="generateJson" icon="el-icon-tickets" @click="handleGenerateJson">{{ $t('fm.actions.json') }}</el-button>
            <el-button v-if="generateCode" icon="el-icon-document" @click="handleGenerateCode">{{ $t('fm.actions.code') }}</el-button>
         </el-button-group>
      ...
      <el-container class="fm2-container">
         ...
         <el-footer height="30px" style="font-weight: 600;"
            >Powered by <a target="_blank" href="https://github.com/GavinZhuLei/vue-form-making">vue-form-making</a></el-footer
         >
      </el-container>
   </span>
</template>
